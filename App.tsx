...
const HomePage: React.FC<{ onNavigate: (route: AppRoute) => void }> = ({ onNavigate }) => (
    <div className="h-full flex flex-col items-center justify-center p-8 relative overflow-hidden text-center">
        ...
        <div className="z-10 text-center max-w-4xl w-full">
            <h1 className="text-6xl lg:text-8xl font-black mb-4 text-transparent bg-clip-text bg-gradient-to-r from-electro-primary via-electro-glow to-electro-accent animate-in fade-in slide-in-from-bottom-5 duration-1000">
                ElectroLearn
            </h1>
            <h2 className="text-2xl font-semibold text-gray-400 mb-6 animate-in fade-in slide-in-from-bottom-5 duration-1000 delay-200">
                מואמן מצרי
            </h2>
